        ...
        child: Column(
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
               GaugeWidget(value: 320, label: "R"),
               GaugeWidget(value: 240, label: "Y"),
               GaugeWidget(value: 40, label: "B"),
              ],
            ),
            SizedBox(height: 10,),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                GaugeTwoWidget(value1: 150, label2: "R"),
                GaugeTwoWidget(value1: 250, label2: "Y"),
                GaugeTwoWidget(value1: 350, label2: "B"),
              ],
            )
          ],
        ),
